...
const SERVICES = [
  {
    ...
    price: "₹5,000 / acre",
    desc: "High-precision topographical surveys. Get point cloud data and orthomosaic maps.",
    img: "",
  },
  {
    id: 102,
    title: "Excavator (JCB) Rental",
    price: "₹1,200 / hour",
    desc: "Heavy-duty excavators with experienced operators. Minimum 8 hours booking.",
    img: "",
  },
  {
    id: 103,
    ...
    price: "₹2,500 / day",
    desc: "High-capacity concrete mixers for large scale pouring operations.",
    img: "",
  },
  {
    id: 104,
    title: "Soil Testing",
    price: "₹15,000 / report",
    desc: "Comprehensive geotechnical investigation including borehole drilling and lab testing.",
    img: "",
  },
  {
    id: 105,
    title: "Crane Rental (50 Ton)",
    price: "₹18,000 / shift",
    desc: "Heavy lifting cranes for steel erection and precast concrete placement.",
    img: "",
  },
  {
    id: 106,
    ...
    price: "Custom / sqft",
    desc: "Safe and controlled demolition with debris removal and site clearance.",
    img: "",
  },
  {
    id: 107,
    ...
    price: "₹40 / sqft",
    desc: "Complete 2D and 3D architectural rendering and structural blueprints.",
    img: "",
  },
];
    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="container mx-auto px-4 pt-20 pb-16">
        ...
        <p className="text-xl md:text-2xl text-gray-500 font-medium max-w-2xl">
          Professional heavy equipment and specialized site services for
          seamless execution.
        </p>
      </section>
            ...
            >
              <div className="flex-grow">
                ...
                <div className="text-3xl font-black">
                  ...
                  <span className="text-xl font-bold text-gray-500 group-hover:text-gray-400 ml-2">
              ...
              <div className="w-full md:w-auto shrink-0 flex flex-col gap-4 items-end">
                <button
                  onClick={() => openWhatsApp(service.title, location)}
